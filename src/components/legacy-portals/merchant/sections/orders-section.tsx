...
import { dateLabel, money, numberValue, rows, statusLabel, text, type PortalRow } from "@/components/merchant/portal-utils";
...
export function OrdersSection({ payload, locale, refresh, notify }: SectionProps) {
  ...
  const visible = useMemo(() => orders.filter((order) => {
    ...
    if (filter === "pending_merchant_confirmation") return awaitingConfirmationStatuses.includes(status);
