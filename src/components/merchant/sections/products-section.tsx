  ...
  async function saveQuick(product: PortalRow) {
    ...
    try {
      await portalPost("save_product", {
        id, name: text(product.free_name), categoryId: text(product.category_id), price, quantity, unit: text(product.unit, "قطعة"),
