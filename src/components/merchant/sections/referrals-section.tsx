...
export function ReferralsSection({ payload, locale, notify }: SectionProps) {
  ...
  return <div className="portal-section-stack">
    ...
    <PortalPanel title={locale === "ar" ? "دعوات المتجر" : "Store referrals"} subtitle={locale === "ar" ? "شارك الرابط، وكل تسجيل مؤكد يتحسب تلقائيًا." : "Share the link; each confirmed registration is counted automatically."}>
